...
graph ER {
  ...
  scale=1.1;
    ...
    node [shape=ellipse]; title, isbn, member_ID, publication_year, name, contact_information
    node [shape=diamond,style=filled,color=lightgrey]; check_outs
...
erDiagram
    LIBRARY_MEMBER ||--|{ BOOK : check_outs
